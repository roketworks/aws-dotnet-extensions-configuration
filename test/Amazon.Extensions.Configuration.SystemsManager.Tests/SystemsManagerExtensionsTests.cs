...
namespace Amazon.Extensions.Configuration.SystemsManager.Tests
{
    public class SystemsManagerExtensionsTests
    {
        ...
        {
            {builder => builder.AddSystemsManager(CreateSource(null, null, false, null, null)), typeof(ArgumentNullException), "Parameter 'Path'"},
            {builder => builder.AddSystemsManager(CreateSource(null, null, true, null, null)), typeof(ArgumentNullException), "Parameter 'Path'"},
        ...
        {
            {builder => builder.AddSystemsManager(null, null), typeof(ArgumentNullException), "Parameter 'path'"},
            {builder => builder.AddSystemsManager("/path", null), typeof(ArgumentNullException), "Parameter 'awsOptions'"},
            {builder => builder.AddSystemsManager(null, new AWSOptions()), typeof(ArgumentNullException), "Parameter 'path'"},
        ...
        {
            {builder => builder.AddSystemsManager(null as string), typeof(ArgumentNullException), "Parameter 'path'"},
